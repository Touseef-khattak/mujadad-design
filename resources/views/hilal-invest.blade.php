            ...
            <div class="my-5">
                <div class="row">
                    <div class="col-12 col-lg-6">
                        <h1 class="secondary-heading-case"><span style="color: #0D132080">Creation of</span>
            ...
            <div class="my-5 py-5">
                ...
                <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="text-side d-flex flex-column justify-content-center h-100 px-4">
                                <div class="streaming-para my-3">
                                    <h3 class="primary-head-case">Overview</h3>
                                    <p>
                ...
                <div class="row my-5">
                        ...
                        <div class="col-md-6">
                            <div class="text-side d-flex flex-column justify-content-center h-100 px-4">
                                <div class="streaming-para my-3">
                                    <h3 class="primary-head-case">Risk Level Calculator</h3>
                                    <p>Our step-by-step method let us scale the new design across all sections from transactions to goal planners</p>
                                </div>
                            </div>
                        </div>
